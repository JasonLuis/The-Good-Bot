...
class DatabaseHelper {
  ...
  Future<Database> _createDatabase() async {
    ...
    String dbPath = join(databasesPath, 'thegoodbot.db');
  ...
  void _createTables(Database database, int version) async {
    ...
    await database.execute('CREATE TABLE MensagensBot(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,nome TEXT,mensagem TEXT)');
  }
}
